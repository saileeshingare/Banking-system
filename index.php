...
<head>
  ...
  <title>Springwell Financial Inc.</title>
...
<body>
  ...
  <section class="topContent">
    <div class="mainHeading">
      <div>
        <span class="main-content">Springwell Financial Inc.</span>
      </div>
      <div style="margin-top: 12px;">
        <span class="sub-content">A basic banking system for making transactions among users</span>
      </div>
      <a href="#services" class="btn btn-outline-primary mt-3">Get Started</a>
    </div>
    <div class="topContentImg">
      <img src="images/homepage_img.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/homepage_img2.jpg" alt="TSF Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          <div>
            <span class="text">Springwell Financial Inc.</span>
          </div>
          <div class="mt-2">
            <span class="sub-content">It is a simple banking system that allows users to conduct transactions.
            It can move money between multiple accounts, display all of a customer's information, and track all previous transactions between accounts.</span>
          </div>
      ...
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">View our customer's information </p>
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">View past transactions between accounts</p>
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text"> Transfer money among accounts</p>
